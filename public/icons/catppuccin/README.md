...
- `latte/` is used in pi-studio's light theme.
- `mocha/` is used in pi-studio's dark theme.
- pi-studio uses the SVG alpha channel as a mask and applies `var(--text-dim)`,
